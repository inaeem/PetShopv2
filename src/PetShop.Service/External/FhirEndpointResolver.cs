...
/// <see cref="FhirEndpointsSettings"/> snapshot is read once via <see cref="IOptions{T}"/>
/// and projected into name/type indexes at construction. Duplicate names are rejected
/// at startup by the validator, so the name dictionary build is safe.
/// </summary>
public class FhirEndpointResolver : IFhirEndpointResolver
{
    ...
    public FhirEndpointResolver(IOptions<FhirEndpointsSettings> options)
    {
